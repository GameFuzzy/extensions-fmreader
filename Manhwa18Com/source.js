...
class FlatMangaReader extends paperback_extensions_common_1.Source {
    constructor() {
        ...
        */
        ...
        this.headerSelector = "h3 a, .series-title a";
        this.altNameSelector = "li:contains(Other names)";
        this.altName = "Alternative Name"; // the alt name already contains ": " eg. ": alt name1, alt name2"
        this.mangaIconDomain = "";
        this.chapterQuerySelector = "div#tab-chapper";
        this.chapterItemSelector = 'tr';
        this.chapterUrlSelector = "a";
        this.chapterTimeSelector = "time, .chapter-time, .publishedDate";
        this.chapterNameAttrSelector = "title";
        this.chapterDetailsImageSelector = "img.chapter-img";
        this.popularSort = "sort=views";
        this.mangaListPath = 'manga-list.html';
        /**
         * Enable if the page URIs are Base64 encoded
         */
        this.pageListBase64Encoded = false;
        /**
...
class Parser {
    constructor() {
        ...
        this.isLastPage = ($) => {
            ...
            const curPageElemText = (_c = (_b = (_a = $(curPageSelector)) === null || _a === void 0 ? void 0 : _a.first()) === null || _b === void 0 ? void 0 : _b.text()) !== null && _c !== void 0 ? _c : '';
    ...
    parseMangaDetails($, mangaId, source) {
        ...
        const titles = [];
        titles.push(entities_1.decodeHTML($('ul.manga-info > *').first().text().trim())); //Main English title
        const altTitles = $(source.altNameSelector).text().split(',');
        for (const title of altTitles) {
            titles.push(entities_1.decodeHTML(title.trim()));
        }
        const author = $('li a.btn-info').text().trim().replace('Updating', '') || undefined;
        const image = this.getImageSrc($('img.thumbnail'));
        const desc = entities_1.decodeHTML($('div.detail .content, div.row ~ div.row:has(h3:first-child) p, .summary-content p').text().trim());
        const genres = [];
        ...
        const tags = [createTagSection({
                id: '0',
                label: 'genres',
                tags: genres
            })];
        const statusStr = (_a = $('li a.btn-success', infoElement).first()) === null || _a === void 0 ? void 0 : _a.text().replace(/ /g, '');
        let status;
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const chapter of $('div#list-chapters p, table.table tr, .list-chapters > a').toArray().reverse()) {
            ...
            const id = (_b = (_a = chapterElem.attr('href')) === null || _a === void 0 ? void 0 : _a.replace('.html', '')) !== null && _b !== void 0 ? _b : '';
    ...
    parseMangaTiles($, source) {
        var _a;
        const collectedIds = [];
        const items = [];
        for (const manga of $('div.media, .thumb-item-flow').toArray()) {
            const id = (_a = $(source.headerSelector, manga).attr('href')) === null || _a === void 0 ? void 0 : _a.replace('.html', '');
            ...
            items.push(createMangaTile({
                id: id,
                image: image || 'https://i.imgur.com/GYUxEX8.png',
                title: createIconText({ text: entities_1.decodeHTML(title) }),
    ...
    getImageSrc(elem) {
        var _a;
        let image = (_a = elem.attr(this.getImageAttr(elem))) !== null && _a !== void 0 ? _a : '';
        return encodeURI(decodeURI(image.trim()));
    }
    decodeBase64ImageSrc(elem) {
        var _a, _b, _c;
        let attr = this.getImageAttr(elem);
        if (!((_a = elem.attr(attr)) === null || _a === void 0 ? void 0 : _a.includes('.'))) {
            return atob((_b = (elem.attr(attr))) !== null && _b !== void 0 ? _b : '');
        }
        else {
            return (_c = elem.attr(`abs:${attr}`)) !== null && _c !== void 0 ? _c : '';
        }
    }
}
